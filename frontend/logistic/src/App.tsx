    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-32 pb-20 px-8 bg-gradient-to-b from-black via-zinc-900 to-black">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white text-lg h-14 px-10 border-0">
              Rozpocznij dobieranie zlecenia
              <Truck className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" variant="outline" className="border-zinc-700 text-white hover:bg-zinc-900 text-lg h-14 px-10">
              Zobacz demo
            </Button>
          </div>
        </div>
      ...
      <section className="py-24 px-8 bg-gradient-to-r from-red-950 via-red-900 to-red-950">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <Button size="lg" className="bg-white text-red-900 hover:bg-zinc-100 text-lg h-14 px-10 font-semibold">
